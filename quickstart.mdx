...
curl -X POST "https://storhaug.targeter.tech/api/campaigns" \
  ...
  -d '{
    "source": {
      ...
      "destination_url": "https://client-site.com/property/001"
    }
  }'
```

Depending on whether a campaign already exists, you get **200** or **201** with an `id`. Use [`GET /campaign`](/api-reference/endpoint/campaign/get) to fetch the campaign, stats, and app link. See [Create campaign](/api-reference/endpoint/campaign/create).
